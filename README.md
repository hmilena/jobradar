...
- **O peso duplo da demissão** — quando a empresa cliente decide terminar o projeto ou dispensar o recurso, o trabalhador enfrenta dois golpes em simultâneo: sai do ambiente onde trabalhava no dia a dia e fica em suspenso na consultoria, à espera de uma nova alocação que pode não chegar. É o impacto emocional e financeiro de uma demissão, sem a clareza ou os direitos de uma. A incerteza prolonga-se: nem se está empregado de facto, nem se pode avançar com segurança.
- **Perda de controlo sobre onde se trabalha** — ao ser contratado por uma consultoria, é a consultoria que decide onde és alocado. Podes ser colocado num projeto ou empresa com quem tens história negativa, num cliente com uma cultura de trabalho incompatível, ou numa localização geograficamente distante que nunca foi acordada. A mobilidade é uma conveniência para a consultoria, não uma escolha do trabalhador.
...
- **The double weight of being let go** — when the client company decides to end a project or release a resource, the worker takes two hits at once: they leave the environment where they actually worked day-to-day, and they're left in limbo at the consultancy, waiting for a new placement that may never come. It carries the emotional and financial weight of a layoff, without the clarity or the rights of one. The uncertainty drags on: you're neither truly employed nor free to move forward with confidence.
- **Loss of control over where you work** — when hired by a consultancy, it's the consultancy that decides where you're placed. You can be allocated to a project or company you have a negative history with, a client with an incompatible work culture, or a location that was never part of the agreement. Mobility is a convenience for the agency, not a choice for the worker.
